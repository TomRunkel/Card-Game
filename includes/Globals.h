...
inline std::vector<Cards::Card> *CurrentDraftDeck;
inline std::vector<Cards::Card> DeckB;
inline std::vector<Cards::Card> DeckD;
inline std::vector<Cards::HandCard> DeckH;
inline std::vector<Cards::Card> Deck[COUNT_PLAYERS];
inline std::vector<Cards::Card> DefenderDeck[COUNT_PLAYERS];
...
inline int defenderPos[COUNT_PLAYERS] = { 0, 0 };
...
inline bool flag_assassin[COUNT_PLAYERS] = { 0, 0 };
inline bool flag_saboteur[COUNT_PLAYERS] = { 0, 0 };
inline bool flag_possible = false;
inline bool flag_wait = true;
inline bool flag_matchStart = false;
inline bool flag_defenders = false;
inline bool flag_attacker = false;
inline bool flag_winner = false;
inline bool flag_showDeckWhole = false;
inline bool flag_robust[COUNT_PLAYERS] = { 0, 0 };
inline int countCards[COUNT_PLAYERS] = { 0, 0 };
inline int count_elves[COUNT_PLAYERS] = { 0, 0 };
